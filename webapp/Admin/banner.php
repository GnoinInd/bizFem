      ...
      <div class="layout-page">
        ...
        <div class="content-wrapper">
          ...
          <div class="container-xxl flex-grow-1 container-p-y">
            <h4 class="py-3 mb-4"><span class="text-muted fw-light">Banner Setting/</span> banner</h4>
            <div class="row">
              <div class="col-md-12">
                <div class="card mb-4">
                  <hr class="my-0" />
                    ...
                    <form id="formAccountSettings" method="POST" onsubmit="return false">
                      <div class="row">
                        <div class="mb-3 col-md-6">
                          <label for="firstName" class="form-label">Banner Heading</label>
                          <input class="form-control" type="text" id="firstName" name="firstName" value="Banner Heading" autofocus />
                        </div>
                        <div class="mb-3 col-md-6">
                          <label for="lastName" class="form-label">banner Title</label>
                          <input class="form-control" type="text" name="lastName" id="lastName" value="banner Title" />
                        </div>
                        <div class="mb-3 col-md-6">
                          <label for="email" class="form-label">banner Content</label>
                          <input class="form-control" type="text" id="text" name="bannerContent" value="banner Content" placeholder="john.doe@example.com" />
                        </div>
                        <div class="button-wrapper">
                          <label for="upload" class="btn btn-primary me-2 mb-4" tabindex="0">
                            <span class="d-none d-sm-block">Upload Banner image</span>
