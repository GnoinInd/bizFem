...
<body>
  ...
  <header class="sticky-top">
    <nav class="navbar  navbar-expand-lg  bg-body-tertiary">
      <div class="container">
        <div class="logoimg ">
          <a class="navbar-brand" href="index.php"><img src="./resource/images/logo/company/logo.png" alt="" class="img-fluid w-100"></a>
        </div>
        ...
        <div class="collapse navbar-collapse w-100 " id="navbarNav">
          <ul class="navbar-nav ms-auto">
            <li class="nav-item">
              <a class="nav-link active" aria-current="page" href="#" data-bs-toggle="modal" data-bs-target="#exampleModal">Try mobile app</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="./webapp/pricing.php">Pricing</a>
            </li>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="./webapp/aboutus.php">About Us</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="./webapp/gst-accounting-pc.php">Desktop</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="./webapp/careers.php">Careers</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="./webapp/partner-with-us.php">Partner with us</a>
            </li>

            <li class="nav-item">
              <a class="nav-link" href="index.php" data-bs-toggle="offcanvas" data-bs-target="#offcanvasRight" aria-controls="offcanvasRight">Login</a>
            </li>
          </ul>
        </div>
      </div>
